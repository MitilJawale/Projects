...
public abstract class Hilt_ForgotPasswordFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ForgotPasswordFragment() {
    super();
  }

  Hilt_ForgotPasswordFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ForgotPasswordFragment_GeneratedInjector) this.generatedComponent()).injectForgotPasswordFragment(UnsafeCasts.<ForgotPasswordFragment>unsafeCast(this));
    }
  }
