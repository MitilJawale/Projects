...
public abstract class Hilt_OtpSignInFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_OtpSignInFragment() {
    super();
  }

  Hilt_OtpSignInFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OtpSignInFragment_GeneratedInjector) this.generatedComponent()).injectOtpSignInFragment(UnsafeCasts.<OtpSignInFragment>unsafeCast(this));
    }
  }
