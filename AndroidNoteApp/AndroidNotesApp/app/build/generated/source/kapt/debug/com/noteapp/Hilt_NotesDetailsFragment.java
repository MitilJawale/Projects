...
public abstract class Hilt_NotesDetailsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NotesDetailsFragment() {
    super();
  }

  Hilt_NotesDetailsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NotesDetailsFragment_GeneratedInjector) this.generatedComponent()).injectNotesDetailsFragment(UnsafeCasts.<NotesDetailsFragment>unsafeCast(this));
    }
  }
