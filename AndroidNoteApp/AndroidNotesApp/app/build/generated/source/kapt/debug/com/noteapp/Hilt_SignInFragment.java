...
public abstract class Hilt_SignInFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SignInFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SignInFragment_GeneratedInjector) this.generatedComponent()).injectSignInFragment(UnsafeCasts.<SignInFragment>unsafeCast(this));
    }
  }
