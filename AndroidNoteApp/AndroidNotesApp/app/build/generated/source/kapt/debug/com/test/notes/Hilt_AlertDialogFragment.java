...
public abstract class Hilt_AlertDialogFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AlertDialogFragment() {
    super();
  }

  Hilt_AlertDialogFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AlertDialogFragment_GeneratedInjector) this.generatedComponent()).injectAlertDialogFragment(UnsafeCasts.<AlertDialogFragment>unsafeCast(this));
    }
  }
