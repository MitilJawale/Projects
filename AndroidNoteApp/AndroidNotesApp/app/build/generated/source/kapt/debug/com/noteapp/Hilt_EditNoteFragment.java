...
public abstract class Hilt_EditNoteFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EditNoteFragment() {
    super();
  }

  Hilt_EditNoteFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EditNoteFragment_GeneratedInjector) this.generatedComponent()).injectEditNoteFragment(UnsafeCasts.<EditNoteFragment>unsafeCast(this));
    }
  }
